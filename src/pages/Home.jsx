      ...
      >
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="hero-subtitle text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Connecting Rwandans with their belongings. Simple, safe, and effective way to reunite people with their items.
          </p>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-500 to-orange-700">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8">
            Join hundreds of Rwandans already using Lost & Found to reconnect with their belongings.
          </p>
          <Link
            to="/post-item"
