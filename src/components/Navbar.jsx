              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 rounded-full bg-red-500 text-white shadow hover:opacity-90 transition"
                  >
                ...
                <>
                  <Link
                    to="/login"
                    className="px-3 py-2 font-medium text-white hover:text-orange-500 transition"
                  >
                    Login
                  </Link>
                  <Link
              ...
              {user ? (
                <>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center space-x-2 px-4 py-2 rounded-full bg-red-500 text-white shadow hover:opacity-90 transition"
                  >
                    <LogOut className="w-4 h-4" />
                    <span>Logout</span>
                  </button>
                ...
                <>
                  <Link
                    to="/login"
                    onClick={() => setIsMenuOpen(false)}
                    className="block px-3 py-2 rounded-lg font-medium text-white hover:text-orange-500 transition"
                  >
                    Login
                  </Link>
                  <Link
